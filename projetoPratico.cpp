...
void apagarMusica(Musicas vetor[], int numMsc)
{
    ...
    for (int i = 0; i < numMsc; i++)
    {
        ...
        if (!vetor[i].apagada && toLowerCustom(vetor[i].nomeMsc) == nomeBusca)
        {
            ...
            encontrou = true;
            cout << "\33[1;32mMúsica '" << vetor[i].nomeMsc << "' apagada com sucesso!\033[m" << endl;
        }
    }

    if (!encontrou)
    {
        cout << "\033[1;31mNenhuma musica com esse nome foi encontrada!\033[m" << endl;
    }
}
...
void procuraArtista(int tam, string vet[], string artista, Musicas musicAdd[], int vet_aux[])
{
    ...
    {
        cout << endl;
        cout << "\33[1;31mNão existe esse artista no arquivo!!\33[m" << endl;
        cout << endl;
    }
}
...
void procuraMusica(int tam, string vet[], string musica, int vet_aux[], Musicas musicAdd[])
{
    ...
    {
        cout << endl;
        cout << "\33[1;31mNão existe essa música no arquivo!!\33[m" << endl;
        cout << endl;
    }
}
...
void busca_dos_anos(int tam, int *&vetor_pos, int vet[], int anoBusca, int &ocasioes)
{
    ...
    {
        cout << endl;
        cout << "\033[1;31mERRO! Não foi possivel achar uma música na lista lançada em " << anoBusca << "!!!\033[m" << endl;
        cout << endl;
        return;
    }
    ...
    else
    {
        ...
        while (busca != "9")
        {
            ...
            else if (busca == "2")
            {
                ...
                {
                    int impressoes = 0;
                    int i = posicao_inicial - 1;

                    while(i < numMsc && impressoes < (posicao_final - posicao_inicial + 1)) {
                        if(!musicAdd[i].apagada){
                            musicAdd[i].imprimir();
                            impressoes++;
                        }
